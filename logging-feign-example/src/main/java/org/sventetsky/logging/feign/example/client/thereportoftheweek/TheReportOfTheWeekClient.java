...
import org.sventetsky.logging.feign.example.client.thereportoftheweek.configuration.TheReportOfTheWeekClientConfiguration;
...
@FeignClient(
        ...
        configuration = TheReportOfTheWeekClientConfiguration.class
)
